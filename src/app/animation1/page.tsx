...
export default function SpeechFunPage() {
  ...
  return (
    // Change your top div to include "pt-20" (padding top)
<div className="w-[1440px] h-[1000px] mx-auto bg-white flex flex-col items-center pt-20">
      {/* 1. WELCOME HEADER */}
      ...
      {/* 2. TITLE BANNER */}
      <section className="mt-[20px] w-full h-[100px] bg-[#95D5F8] flex flex-col items-center justify-center text-center mb-10">
      ...
      <div className="w-full flex justify-center">
        <button 
          ...
          className="bg-[#F6A572] hover:bg-[#E28A4F] text-black font-black w-[300px] h-[45px] my-[20px] mr-[150px] rounded-[30px] flex items-center justify-center text-[20px] uppercase tracking-widest shadow-md transition-all active:scale-95 font-playpen border-none outline-none"
        >
          RESTART
        </button>
      </div>
