...
{/* 4. ACTIVITY GRID - Fixed Syntax Here */}
      <main className="w-full flex flex-col items-center pb-24 mr-[150px] mt-[20px]">
...
function ActivityCard({ title, description, imageSrc, btnText, btnColor, href }: any) {
  return (
    <article className="w-[500px] h-[250px] bg-white rounded-[25px] p-6 border border-gray-200 shadow-[8px_8px_0px_rgba(0,0,0,0.1)] flex flex-col">
