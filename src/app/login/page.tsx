...
<form className="w-full max-w-[600px] space-y-6">
  ...
  {/* Username Field */}
  <div>
    <label className="mt-[15px] block text-[16px] font-bold text-gray-800 font-playpen mb-2">
      Username <span className="text-[13px] font-normal text-gray-500 italic">(only letters, numbers and underscores)</span>
    </label>
    <input 
      type="text" 
      className="w-full h-[45px] border border-gray-400 px-4 rounded-sm focus:outline-none focus:ring-1 focus:ring-blue-400 bg-white" 
    />
  </div>
