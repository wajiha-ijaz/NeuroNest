  ...
  return (
    ...
    <div className="w-full h-screen bg-white flex flex-col justify-between overflow-hidden relative">
      ...
      <header className="w-full flex flex-col items-center">
        ...
        <div className="w-full h-[10vh] min-h-[60px] max-h-[90px] bg-[#7ECE68] flex flex-col items-center justify-center text-center shadow-sm">
          ...
          <p className="text-[14px] md:text-[16px] text-black/80 font-bold font-playpen">
            Challenge yourself with classic puzzle-solving.
          </p>
        </div>
      </header>
      ...
      <div className="w-full flex justify-center items-center gap-6 mb-[2vh]">
        {/* PLAY NOW */}
        <a
          href={`${DJANGO_BASE_URL}/tower-hanoi/`}
          className="bg-[#7ECE68] hover:bg-[#E28A4F] text-black font-black w-[240px] md:w-[280px] h-[45px] rounded-[30px] flex items-center justify-center text-[16px] md:text-[18px] uppercase tracking-widest shadow-md transition-all active:scale-95 font-playpen border-none outline-none no-underline"
        >
          PLAY NOW
        </a>
        ...
        {/* VIEW PROGRESS */}
        <a
          href={`${DJANGO_BASE_URL}/tower-hanoi-progress/`}
          target="_blank"
