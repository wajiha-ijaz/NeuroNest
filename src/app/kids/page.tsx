...
{/* 3. SEGMENTED TOGGLE BAR */}
    ...
    <Link href="/kids" className="no-underline">
      <button className="ml-[30px] w-[160px] h-[40px] bg-[#87D1FF] text-black font-bold text-[16px] rounded-[40px] shadow-[0px_4px_8px_rgba(0,0,0,0.15)] transition-all flex items-center justify-center">
        Kids (3-12)
      </button>
    </Link>
...
<main className="w-full flex-1 max-h-[62vh] flex items-center justify-center gap-8 px-6 my-[1vh]">
  ...
  <GameCard 
    title="Animations"
    description="Educational animations that will help the kids to learn about their basic chores and help them grow."
    imageSrc="/pic1.png" 
    bgColor="bg-white" 
    btnColor="bg-[#F6A572]"
    href="/animations"
  ...
  <GameCard 
    title="Kids Games"
    description="Games that will help the autistic kid to grow, learn, and improve brain development."
    imageSrc="/pic2.png" 
    bgColor="bg-white" 
    btnColor="bg-[#C499F3]"
    href="/kidsgames"
