...
<section className="flex justify-center mb-16">
  <div className="flex items-center justify-between px-6 bg-white border-[3px] border-gray-300 rounded-[55px] w-[900px] h-[90px] shadow-[0px_4px_10px_rgba(0,0,0,0.1)] mr-[170px] m-[30px]">
    ...
    <Link href="/kids" className="no-underline">
      <button className="ml-[30px] w-[218px] h-[65px] bg-[#87D1FF] text-black font-bold text-[22px] rounded-[40px] shadow-[0px_4px_8px_rgba(0,0,0,0.15)] transition-all flex items-center justify-center">
        Kids (3-12)
      </button>
    </Link>
    ...
    <Link href="/teens" className="no-underline">
      <button className="w-[218px] h-[65px] bg-transparent text-gray-500 font-bold text-[22px] rounded-[40px] hover:text-black hover:bg-gray-50 transition-all flex items-center justify-center">
        Teens (13-17)
      </button>
    </Link>
  ...
  <GameCard 
    title="Animations"
    description="Animations of daily life tasks that will help the kids to learn about their basic chores and help them grow."
    imageSrc="/pic1.png" 
    bgColor="bg-white" 
    btnColor="bg-[#F6A572]"
    href="/animations"
  ...
  <GameCard 
    title="Kids Games"
    description="Different types of games that will help the autistic kid to grow and learn and improve brain development."
    imageSrc="/pic2.png" 
    bgColor="bg-white" 
    btnColor="bg-[#C499F3]"
    href="/kidsgames"
  ...
  return (
    <article className={`${bgColor} w-[450px] h-[500px] rounded-[48px] p-12 shadow-[12px_12px_0px_0px_rgba(0,0,0,0.15)] border border-white/40 flex flex-col text-center transition-all hover:-translate-y-2 mr-[50px] mt-[25px]`}>
      
      {/* White Image Container */}
      <div className="bg-white w-[350px] h-[350px] rounded-[36px] mb-8 flex items-center justify-center relative overflow-hidden p-10 shadow-inner m-[50px]">
      ...
      <div className="-mt-[70px] gap-[10px] flex flex-col items-center flex-grow">
        <h3 className="text-[38px] font-extrabold text-black mb-6 font-playpen">
          {title}
        </h3>
        <p className="text-[18px] text-gray-600 font-medium leading-relaxed max-w-[400px] px-4">
          {description}
        </p>
      </div>
